...
\label{sec:preface}
  ...
  \label{sub:introduction}
    ...
    This PDF has taken the content of the \href{https://www.demandenergyequality.org/make-your-own-power-banks}{\underline{"Make Your Own Lithium Power Banks"}} PDF and put them into a form which can be easily corrected, improved and translated by the community using LaTeX a markdown language for technical topics.
  ...
  \label{sub:notes}
    ...
    \begin{enumerate}
      ...
      \item Any updates, corrections or translations to the PDF will be available at \href{https://github.com/darigovresearch/Make-Your-Own-Lithium-Power-Banks}{\underline{https://github.com/darigovresearch/Make-Your-Own-Lithium-Power-Banks}} so do return periodically to check if you have the latest version.
  ...
  \label{sub:license}
    ...
    This work was based on the work \textbf{\textit{Make Your Own Lithium Power Banks}} by \href{https://www.demandenergyequality.org/}{\underline{Demand Energy Equality}}, licensed under a \href{https://creativecommons.org/licenses/by-sa/4.0/legalcode}{\underline{Creative Commons BY-SA}}.

    To see this work in full go to \href{https://www.demandenergyequality.org/make-your-own-power-banks}{\underline{https://www.demandenergyequality.org/make-your-own-power-banks}}
...
\label{sec:basic_concepts}
  ...
  {\color{blue}\subsection{Battery capacity}} % (fold)
...
{\color{blue}\section{Risks and dangers of lithium-ion batteries}} % (fold)
\label{sec:risks_and_dangers_of_lithium_ion_batteries}
  ...
  {\color{blue}\subsection{Minimising the risk of lithium-ion battery fires}} % (fold)
...
{\color{blue}\section{What are lithium-ion battery cells?}} % (fold)
\label{sec:what_are_lithium_ion_battery_cells}
  ...
  {\color{blue}\subsection{Comparing Lead-acid and Lithium batteries}} % (fold)
  ...
  {\color{blue}\subsection{Lithium-ion charging}} % (fold)
  ...
  {\color{blue}\subsection{Caring for lithium-ion batteries}} % (fold)
...
{\color{blue}\section{Collecting 18650 cells}} % (fold)
\label{sec:collecting_18650_cells}
  ...
  {\color{blue}\subsection{Where to find second hand 18650 lithium cells}} % (fold)
  ...
  {\color{blue}\subsection{18650 cell configurations}} % (fold)
  ...
  {\color{blue}\subsection{How to safely recover 18650 lithium-ion cells from a laptop battery}} % (fold)
  ...
  {\color{blue}\subsection{How to test 18650 cells}} % (fold)
...
{\color{blue}\section{Building a USB power bank}} % (fold)
...
{\color{blue}\section{Building a bigger battery pack}} % (fold)
\label{sec:building_a_bigger_battery_pack}
  ...
  You can find further information about how to design a basic off grid energy system in our \href{https://www.demandenergyequality.org/get-started-with-offgrid}{\underline{Intro to Off Grid guide}}.

% section building_a_bigger_battery_pack (end)

{\color{blue}\section{Lithium battery chemistries, applications and form factors}} % (fold)
...
\label{sec:resources}
  ...
  \subsubsection{Useful Information On Lithium Cells} % (fold)
  \label{ssub:useful_information_on_lithium_cells}

    \begin{enumerate}
      \item How do lithium batteries work? \newline
        \href{https://batteryuniversity.com/learn/article/lithium\_based\_batteries}{\underline{https://batteryuniversity.com/learn/article/lithium\_based\_batteries}}
      \item What’s inside an 18650 cell? And why it’s important: \newline
        \href{https://www.electricbike.com/inside-18650-cell/}{\underline{https://www.electricbike.com/inside-18650-cell/}}
      \item 18650 things to do with an old laptop battery: \newline
        \href{https://www.wired.com/2011/09/18650-things-to-do-with-an-old-laptop-battery/}{\underline{https://www.wired.com/2011/09/18650-things-to-do-with-an-old-laptop-battery/}}
      \item How to open laptop battery without damaging the cells: \newline
        \href{https://www.youtube.com/watch?v=7arwwTGliUA}{\underline{https://www.youtube.com/watch?v=7arwwTGliUA}}
    \end{enumerate}
  
  % subsubsection useful_information_on_lithium_cells (end)
  ...
  \label{ssub:other_renewable_energy_resources}
    ...
    \begin{enumerate}[resume]
      ...
      \item DIY solar panels: \newline
        \href{https://www.demandenergyequality.org/build-your-own-panels}{\underline{https://www.demandenergyequality.org/build-your-own-panels}}
      \item How solar cells work: \newline
        \href{https://www.demandenergyequality.org/guide-to-solar-energy}{\underline{https://www.demandenergyequality.org/guide-to-solar-energy}}
      \item DIY bike power: \newline
        \href{https://www.demandenergyequality.org/build-your-own-bike-generators}{\underline{https://www.demandenergyequality.org/build-your-own-bike-generators}}
  ...
  \subsubsection{Lithium battery suppliers for off grid systems} % (fold)
  \label{ssub:lithium_battery_suppliers_for_off_grid_systems}

    \begin{enumerate}[resume]
      \item Wind and sun: \href{http://www.windandsun.co.uk/products/Batteries/Lithium-Ion-Batteries}{\underline{http://www.windandsun.co.uk/products/Batteries/Lithium-Ion-Batteries}}
      \item Bimble solar: \href{https://www.bimblesolar.com/batteries/lithium-batteries}{\underline{https://www.bimblesolar.com/batteries/lithium-batteries}}
    \end{enumerate}
  
  % subsubsection lithium_battery_suppliers_for_off_grid_systems (end)
